...
class QuestionListModel {
  ...
  QuestionListModel({this.id, this.haveImage, this.imageURL, this.minute, this.options, this.qustion, this.secounds, this.timeout = 0, this.answerKey = ''});
  ...
  QuestionListModel.fromJson(Map<String, dynamic> json) {
    ...
    timeout = Duration(minutes: int.parse(json['minute']), seconds: int.parse(json['secounds'])).inSeconds;
    answerKey = '';
  }
