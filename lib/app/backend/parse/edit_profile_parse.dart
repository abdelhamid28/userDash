...
class EditProfileParser {
  ...
  Future<Response> getUserProfile() async {
    return apiService.postPrivate(AppConstants.getProfile, {"id": sharedPreferencesManager.getString('uid')}, sharedPreferencesManager.getString('token') ?? '');
  }
  ...
  Future<Response> updateProfile(var body) async {
    return apiService.postPrivate(AppConstants.updateProfile, body, sharedPreferencesManager.getString('token') ?? '');
  }
  ...
  void saveInfo(String firstName, String lastName, String cover, String phone, int termId, int studyId) {
