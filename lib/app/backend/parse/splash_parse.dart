...
class SplashParser {
  ...
  Future<Response> getAppSettings() async {
    print(" ***** getAppSettings${apiService.getPublic(AppConstants.appSettings)}");
  ...
  void saveBasicInfo(var supportEmail, var appName, var supportName, var supportId, var supportPhone) {
