...
class AppRouter {
  ...
  static List<GetPage> routes = [
    GetPage(name: initialRoutes, page: () => const SplashScreen(), binding: SplashBinding()),
    ...
    GetPage(name: examListRoutes, page: () => const ExamListScreen(), binding: ExamListBindings()),
    GetPage(name: examPaperRoutes, page: () => const ExamPaperScreen(), binding: ExamPaperBindings()),
    GetPage(name: resultRoutes, page: () => const ResultScreen(), binding: ResultBinding()),
    GetPage(name: examStatsRoutes, page: () => const ExamStatScreen(), binding: ExamStatsBinding()),
    GetPage(name: tabsRoutes, page: () => const TabScreen(), binding: TabsBinding()),
    GetPage(name: learningRoutes, page: () => const LearningScreen(), binding: LearningBinding()),
    GetPage(name: accountRoutes, page: () => const AccountScreen(), binding: AccountBindings()),
    GetPage(name: learningListRoutes, page: () => const LearningListScreen(), binding: LearningListBindings()),
    GetPage(name: learningDetailsRoutes, page: () => const LearningDetailScreen(), binding: LearningDetailsBindings()),
    GetPage(name: winnerRoutes, page: () => const WinnerScreen(), binding: WinnerBinding()),
    GetPage(name: appPagesRoutes, page: () => const AppPageScreen(), binding: AppPagesBinding()),
    GetPage(name: editProfileRoutes, page: () => const EditProfileScreen(), binding: EditProfileBindings()),
    GetPage(name: contactRoutes, page: () => const ContactScreen(), binding: ContactBindings()),
    ...
    GetPage(name: resetPasswordRoutes, page: () => const ResetPasswordScreen(), binding: ResetPasswordBinding())
  ];
}
