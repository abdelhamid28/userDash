  ...
  Widget getLanguages() {
    return PopupMenuButton(
      ...
      child: Padding(
        ...
        child: IconButton(icon: const Icon(Icons.translate), color: ThemeProvider.blackColor, onPressed: () {}),
      ),
          ...
          body: SingleChildScrollView(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Text('Login to continue'.tr, style: const TextStyle(fontFamily: 'bold', fontSize: 18)),
         ...
         /*         Row(
                    ...
                    children: [
                      InkWell(
                       ...
                       // child: Text('Forgot Password?'.tr, style: const TextStyle(color: ThemeProvider.appColor)),
                      ),
                    ],
                  ),
            */      const SizedBox(height: 30),
                  Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(onTap: () => Get.toNamed(AppRouter.getRegisterRoutes()), child: Text('Register'.tr, style: const TextStyle(color: ThemeProvider.appColor)))
                      ],
                    ),
                  ),
                ],
