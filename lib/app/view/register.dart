    ...
    return GetBuilder<RegisterController>(
      builder: (value) {
        return Scaffold(
          ...
          appBar: AppBar(elevation: 0, backgroundColor: ThemeProvider.whiteColor),
              ...
              : SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text("Let's get started".tr, style: const TextStyle(fontFamily: 'bold', fontSize: 18)),
                        const SizedBox(height: 10),
                        Text("Please provide valid details".tr, style: const TextStyle(fontFamily: 'semi-bold', fontSize: 14)),
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                              ...
                              child: Icon(value.passwordVisible.value == false ? Icons.visibility : Icons.visibility_off, color: ThemeProvider.greyColor),
                            ),
                            floatingLabelBehavior: FloatingLabelBehavior.auto,
                            enabledBorder: UnderlineInputBorder(borderSide: BorderSide(width: 2, color: (ThemeProvider.greyColor[300])!)),
                            focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(width: 2, color: ThemeProvider.appColor)),
                        ...
                        value.haveStudies == true
                            ? SizedBox(
                                ...
                                child: DropdownButton<StudiesModel>(
                                  ...
                                  onChanged: (newValue) => value.onStudiesChanged(newValue as StudiesModel),
                                ),
                              )
                            : Container(
                                height: 50,
                        ...
                        value.haveTerms == true
                            ? SizedBox(
                                ...
                                child: DropdownButton<TermsModel>(
                                  ...
                                  onChanged: (newValue) => value.onTermsChanged(newValue as TermsModel),
                                ),
                              )
                            : Container(
                                height: 50,
                        ...
                        Center(
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(onTap: () => Get.back(), child: Text('Login'.tr, style: const TextStyle(color: ThemeProvider.appColor)))
                            ],
                          ),
                        ),
                      ],
